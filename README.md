...
```
## Conclusion
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Thanks for reading! Quick reminder that all of this code can be found over on my [Website](https://nthorn.com/blog/diagonal_traversal). Also be sure to read about my [FLS Test](link_coming_soon), which is where I originally needed to be able to read a matrix diagonally.